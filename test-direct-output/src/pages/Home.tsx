    ...
    <div className="page-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">Welcome to Digital Ghost Protocol Test - We are a locally-owned business dedicated to providing exceptional service to our community. With ye...</p>
