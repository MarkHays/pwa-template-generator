        ...
        <div className="container">
          <div className="story-content">
            <div className="story-text">
              <h2>Our Story</h2>
              <p>Healthcare Plus was founded with a simple mission: to provide exceptional services that exceed our clients' expectations. With years of experience in the technology industry, we've built a reputation for quality, reliability, and innovation.</p>
            </div>
